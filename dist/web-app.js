...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__tools_deserializer__ = __webpack_require__(73);


class MelService {
    constructor() {
        this._deserializer = new __WEBPACK_IMPORTED_MODULE_0__tools_deserializer__["a" /* default */]();
    }

    getTracks() {
        return new Promise((resolve, reject) => this._sendRequest("GET", "/api/tracks").then(response => resolve(this._deserializer.deserializeTracks(JSON.parse(response).tracks))).catch(err => reject(err)));
    }

    getArtist(artistId) {
        return new Promise((resolve, reject) => this._sendRequest("GET", "/api/artists/" + artistId).then(response => resolve(this._deserializer.deserializeArtist(JSON.parse(response).artist))).catch(err => reject(err)));
    }

    getArtists() {
        return new Promise((resolve, reject) => this._sendRequest("GET", "/api/artists").then(response => resolve(this._deserializer.deserializeArtists(JSON.parse(response).artists))).catch(err => reject(err)));
    }

    getAlbum(albumId) {
        return new Promise((resolve, reject) => this._sendRequest("GET", "/api/albums/" + albumId).then(response => resolve(this._deserializer.deserializeAlbum(JSON.parse(response).album))).catch(err => reject(err)));
    }
...
/* harmony export (immutable) */ __webpack_exports__["a"] = MelService;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__views_library_view__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__views_artist_view__ = __webpack_require__(81);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__views_album_view__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__web_app_sass__ = __webpack_require__(84);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__web_app_sass___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__web_app_sass__);
...
class WebApp extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    constructor() {
        super();
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'div',
                        null,
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_router_dom__["c" /* Route */], { exact: true, path: '/', component: __WEBPACK_IMPORTED_MODULE_3__views_library_view__["a" /* default */] }),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_router_dom__["c" /* Route */], { path: '/artist/:artistId', component: __WEBPACK_IMPORTED_MODULE_4__views_artist_view__["a" /* default */] }),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_router_dom__["c" /* Route */], { path: '/album/:albumId', component: __WEBPACK_IMPORTED_MODULE_5__views_album_view__["a" /* default */] })
                    )
                )
            )
        );
...
__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(WebApp, null), document.getElementById('root'));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_mel_service__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react_router_dom__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_heading__ = __webpack_require__(77);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_list_view__ = __webpack_require__(78);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__library_view_sass__ = __webpack_require__(80);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__library_view_sass___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__library_view_sass__);
...
class LibraryView extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    constructor() {
        super();
        this.state = {};
        this._melService = new __WEBPACK_IMPORTED_MODULE_1__services_mel_service__["a" /* default */]();
    ...
    renderArtistList() {
        if (this.state.artists) {
            return this.state.artists.sort((a, b) => a.name.localeCompare(b.name)).map((artist, index) => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                __WEBPACK_IMPORTED_MODULE_2_react_router_dom__["b" /* Link */],
                { to: { pathname: "/artist/" + artist.id }, key: artist.id },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'div',
                    { className: 'list-item' },
                    artist.name
    ...
    render() {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                __WEBPACK_IMPORTED_MODULE_3__components_heading__["a" /* default */],
                null,
                'Library'
            ),
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                __WEBPACK_IMPORTED_MODULE_4__components_list_view__["a" /* default */],
                { className: 'list' },
...
/* harmony export (immutable) */ __webpack_exports__["a"] = LibraryView;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__data_track__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data_artist__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__data_album__ = __webpack_require__(76);
...
class Deserializer {
    ...
    deserializeTrack(track) {
        ...
        return new __WEBPACK_IMPORTED_MODULE_0__data_track__["a" /* default */](id, title, artist, album, number, discNumber, filePath);
    }
    ...
    deserializeArtist(artist) {
        ...
        return new __WEBPACK_IMPORTED_MODULE_1__data_artist__["a" /* default */](id, name, albums, featureAlbums);
    }
    ...
    deserializeAlbum(album) {
        ...
        return new __WEBPACK_IMPORTED_MODULE_2__data_album__["a" /* default */](id, artist, title, year, tracks, featureArtists);
    }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = Deserializer;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__list_view_sass__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__list_view_sass___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__list_view_sass__);



class ListView extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
...
class ArtistView extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    constructor(props) {
        super();
        this.state = {};
        this._melService = new __WEBPACK_IMPORTED_MODULE_1__services_mel_service__["a" /* default */]();
    ...
    renderAlbumList() {
        return this.state.artist.albums.sort((a, b) => b.year - a.year).map(album => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            __WEBPACK_IMPORTED_MODULE_2_react_router_dom__["b" /* Link */],
            { key: album.id, to: { pathname: "/album/" + album.id } },
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "div",
                null,
                album.year,
    ...
    renderFeatureAlbumList() {
        return this.state.artist.featureAlbums.sort((a, b) => b.year - a.year).map(album => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            __WEBPACK_IMPORTED_MODULE_2_react_router_dom__["b" /* Link */],
            { key: album.id, to: { pathname: "/album/" + album.id } },
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "div",
...
/* harmony export (immutable) */ __webpack_exports__["a"] = ArtistView;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_mel_service__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__album_view_sass__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__album_view_sass___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__album_view_sass__);





class AlbumView extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    constructor(props) {
        super();
        this.state = {};
        this._melService = new __WEBPACK_IMPORTED_MODULE_2__services_mel_service__["a" /* default */]();
    ...
    renderTrackList() {
        return this.state.album.tracks.sort((a, b) => a.number - b.number).map(track => {
            console.log(track);
            let listArtists = artists => {
                if (artists) {
                    return track.artists.map((artist, index) => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    renderOtherAlbums() {
        ...
        return this.state.album.artist.albums.map(album => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'div',
            { key: album.id },
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'span',
    ...
    render() {
        if (this.state.album) {
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    __WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Link */],
                    { key: 'artist_link', to: { pathname: "/artist/" + this.state.album.artist.id } },
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'p',
                        null,
...
/* harmony export (immutable) */ __webpack_exports__["a"] = AlbumView;
